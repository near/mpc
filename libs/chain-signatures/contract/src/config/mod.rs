...
/// let config = Config { max_num_requests_to_remove: 10, request_timeout_blocks: 1000, reshare_timeout_blocks: 2000 };
...
/// let init_config = InitConfig { max_num_requests_to_remove: Some(10), request_timeout_blocks: Some(1000), reshare_timeout_blocks: None };
...
/// assert_eq!(config.reshare_timeout_blocks, DEFAULT_RESHARE_TIMEOUT_BLOCKS);
/// ```
#[near(serializers=[borsh, json])]
#[derive(Clone, Debug, PartialEq, Eq)]
