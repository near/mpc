...
wasm-opt -Oz -o mpc-contract.wasm target/wasm32-unknown-unknown/release/mpc_contract.wasm
mv mpc-contract.wasm target/wasm32-unknown-unknown/release/mpc_contract.wasm
```
