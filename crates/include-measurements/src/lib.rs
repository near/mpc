...
/// into an [`ExpectedMeasurements`](attestation_types::ExpectedMeasurements) struct literal.
///
/// # Usage
///
/// ```rust,ignore
/// use include_measurements::include_measurements;
/// use attestation_types::ExpectedMeasurements;
///
