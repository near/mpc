...
mod test {
    ...
    use crate::test_utils::{
        MockCryptoRng, assert_buffer_capacity, expected_buffer_by_role, generate_ckd_app_package,
        generate_participants, generate_test_keys, make_keygen_output, run_ckd_pv,
    };
    ...
    fn test_ckd() {
        ...
        let ckd_output =
            run_ckd_pv(&key_packages, coordinator, &app_id, &app_pk, &mut rng).unwrap();
