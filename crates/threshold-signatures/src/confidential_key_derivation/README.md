...
- [`docs/confidential_key_derivation/confidential-key-derivation.md`](../../docs/confidential_key_derivation/confidential-key-derivation.md) -- full protocol specification with security analysis
