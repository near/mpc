...
pub struct Args {
    ...
    /// Can also be set via BACKUP_HOME_DIR environment variable.
...
pub struct RegisterArgs {
    ...
    /// Can also be set via MPC_CONTRACT_ACCOUNT_ID environment variable.
    #[arg(long, env)]
    ...
    /// Can also be set via NEAR_NETWORK environment variable.
    #[arg(long, env)]
    ...
    /// Can also be set via SIGNER_ACCOUNT_ID environment variable.
    #[arg(long, env)]
...
pub struct GetKeysharesArgs {
    ...
    /// Can also be set via MPC_NODE_URL environment variable.
    #[arg(long, env)]
    pub mpc_node_url: String,
    /// P2P public key of the MPC node for authentication.
    /// Can also be set via MPC_NODE_P2P_KEY environment variable.
    #[arg(long, env)]
