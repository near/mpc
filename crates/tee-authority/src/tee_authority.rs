    ...
    async fn fetch_collateral_from(
        ...
        let fetch = async || {
            tokio::time::timeout(PCCS_REQUEST_TIMEOUT, client.fetch(quote))
                ...
                .map(mpc_attestation::dcap_conversions::collateral_from_dcap)
...
mod tests {
    ...
    fn dummy_collateral(tag: &str) -> Collateral {
        mpc_attestation::dcap_conversions::collateral_from_dcap(dcap_qvl::QuoteCollateralV3 {
        ...
        match result {
            Ok(Ok(collateral)) => {
                let dcap_qvl::QuoteCollateralV3 {
                    ...
                    mpc_attestation::dcap_conversions::collateral_into_dcap(collateral);
