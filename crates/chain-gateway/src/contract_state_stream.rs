...
//
//impl StateViewer {
//    pub async fn subscribe<Arg: Serialize, Res: DeserializeOwned>(
//        &self,
//        contract_id: AccountId,
//        method_name: &str,
//        args: &Arg,
...
//    }
//
//    pub(crate) async fn view<Arg, Res>(
//        &self,
//        contract_id: AccountId,
//        method_name: &str,
//        args: &Arg,
...
//
//pub struct ConstractStateSubscriber {
//    /// For querying blockchain sync status.
//    pub(crate) client: Arc<ClientWrapper>,
//    /// for viewing state
//    pub(crate) view_client: Arc<ViewClientWrapper>,
...
//                source: Arc::new(err),
//            })?;
//        let value = serde_json::from_slice::<Res>(&call_result).map_err(|err| {
//            ChainGatewayError::Deserialization {
//                op: ChainGatewayOp::ViewCall {
//                    account_id: contract_id.to_string(),
//                    method_name: method_name.to_string(),
...
//
//
//struct ContractStateStream<Arg, Res>
//where
//    Arg: Serialize,
//    Res: DeserializeOwned,
//{
//    subscription: ContractMethodSubscription,
//    //pub(crate) async fn view<Arg, Res>(
//    //    &self,
//    //    contract_id: AccountId,
//    //    method_name: &str,
...
//}
//
//impl<Arg, Res> ContractStateStream<Arg, Res>
//where
//    Arg: Serialize,
//    Res: DeserializeOwned,
//{
...
//            .into_bytes();
//        let subscription =
//            ContractMethodSubscription::new(state_viewer, contract_id, method_name, args).await?;
