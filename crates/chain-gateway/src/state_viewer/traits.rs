...
use near_contract_transport::ViewContract;
...
// note: IsSyncing could probably be part of transport layer - this is useful in general, e.g., if
// you need to wait for permits to query the RPC endpoit, if you want to throttle etc. and can be
// set to immediate return if it doesn't need to halt...
// you would call it WaitForPermit or sth?
