...
pub const TEST_CONTRACT_ACCOUNT: &str = "test-contract.near";
pub const TEST_STRING: &str = "hello from test";
pub const TEST_METHOD: &str = "get_greeting";

pub async fn setup_chain_gatew() -> (
