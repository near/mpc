...
pub struct BaseChainConfig {
    pub timeout_sec: u64,
    pub max_retries: u64,
    pub providers: NonEmptyBTreeMap<String, BaseProviderConfig>,
}
...
pub struct BaseProviderConfig {
    pub rpc_url: String,
    pub api_variant: BaseApiVariant,
    #[serde(default)]
    pub auth: auth::AuthConfig,
}

impl ForeignChainProviderConfig for BaseProviderConfig {
