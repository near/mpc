...
pub const fn version_3_3_2() -> &'static [u8; 1223846] {
    include_bytes!("../archive/signer-3_3_2.wasm")
}

pub const fn version_3_4_1() -> &'static [u8; 1342917] {
    include_bytes!("../archive/signer-3_4_1.wasm")
}

pub const fn version_3_5_1() -> &'static [u8; 1396979] {
    include_bytes!("../archive/signer-3_5_1.wasm")
}
...
pub const fn version_3_8_1() -> &'static [u8; 1515608] {
    include_bytes!("../archive/signer-3_8_1.wasm")
}

pub const fn version_3_9_0() -> &'static [u8; 1481703] {
    include_bytes!("../archive/signer-3_9_0.wasm")
}

pub const fn version_3_9_1() -> &'static [u8; 1487766] {
    include_bytes!("../archive/signer-3_9_1.wasm")
}

pub const fn version_3_10_0() -> &'static [u8; 1495268] {
    include_bytes!("../archive/signer-3_10_0.wasm")
}

pub const fn version_3_10_1() -> &'static [u8; 1495835] {
    include_bytes!("../archive/signer-3_10_1.wasm")
}

pub const fn version_3_11_2() -> &'static [u8; 1439260] {
...
pub const fn version_3_13_0() -> &'static [u8; 1509901] {
...
pub const fn version_3_14_1() -> &'static [u8; 1182130] {
    include_bytes!("../archive/signer-3_14_1.wasm")
}

pub const fn version_3_15_0() -> &'static [u8; 1229682] {
    include_bytes!("../archive/signer-3_15_0.wasm")
}
