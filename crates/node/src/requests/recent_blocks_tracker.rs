...
use near_indexer_primitives::types::{BlockHeight, BlockReference};
...
pub struct AddBlockResult<T> {
    ...
    pub new_final_blocks: Vec<BlockReference>,
...
pub mod tests {
    ...
    use super::{AddBlockResult, BlockViewLite, RecentBlocksTracker};
