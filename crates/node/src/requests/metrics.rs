...
pub static MPC_PENDING_VERIFY_FOREIGN_TXS_QUEUE_BLOCKS_INDEXED: LazyLock<prometheus::IntCounter> =
    LazyLock::new(|| {
        prometheus::register_int_counter!(
            "mpc_pending_verify_foreign_txs_queue_blocks_indexed",
            "Number of blocks indexed by the pending verify foreign tx queue"
        )
        .unwrap()
    });
pub static MPC_PENDING_VERIFY_FOREIGN_TXS_QUEUE_FINALIZED_BLOCKS_INDEXED: LazyLock<
    prometheus::IntCounter,
> = LazyLock::new(|| {
    prometheus::register_int_counter!(
        "mpc_pending_verify_foreign_txs_queue_finalized_blocks_indexed",
        "Number of finalized blocks indexed by the pending verify foreign tx queue"
    )
    .unwrap()
});
pub static MPC_PENDING_VERIFY_FOREIGN_TXS_QUEUE_REQUESTS_INDEXED: LazyLock<prometheus::IntCounter> =
    LazyLock::new(|| {
        prometheus::register_int_counter!(
            "mpc_pending_verify_foreign_txs_queue_requests_indexed",
            "Number of verify foreign tx requests indexed by the pending verify foreign tx queue"
        )
        .unwrap()
    });
pub static MPC_PENDING_VERIFY_FOREIGN_TXS_QUEUE_RESPONSES_INDEXED: LazyLock<
    prometheus::IntCounter,
> = LazyLock::new(|| {
    prometheus::register_int_counter!(
        "mpc_pending_verify_foreign_txs_queue_responses_indexed",
        "Number of verify foreign tx responses indexed by the pending verify foreign tx queue"
    )
    .unwrap()
});
pub static MPC_PENDING_VERIFY_FOREIGN_TXS_QUEUE_MATCHING_RESPONSES_INDEXED: LazyLock<
    prometheus::IntCounter,
> = LazyLock::new(|| {
    prometheus::register_int_counter!(
        "mpc_pending_verify_foreign_txs_queue_matching_responses_indexed",
...
pub static VERIFY_FOREIGN_TXS_REQUEST_RESPONSE_LATENCY_BLOCKS: LazyLock<prometheus::Histogram> =
    LazyLock::new(|| {
        ...
        prometheus::register_histogram!(
            "mpc_verify_foreign_tx_request_response_latency_blocks",
...
pub static VERIFY_FOREIGN_TXS_REQUEST_RESPONSE_LATENCY_SECONDS: LazyLock<prometheus::Histogram> =
    LazyLock::new(|| {
        prometheus::register_histogram!(
            "mpc_verify_foreign_tx_request_response_latency_seconds",
