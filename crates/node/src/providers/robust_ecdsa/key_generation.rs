...
use crate::providers::robust_ecdsa::{KeygenOutput, RobustEcdsaSignatureProvider};
use rand::rngs::OsRng;
...
mod tests {
    ...
    use crate::providers::robust_ecdsa::key_generation::KeyGenerationComputation;
    use crate::providers::robust_ecdsa::{KeygenOutput, RobustEcdsaTaskId};
