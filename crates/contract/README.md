...
| `launcher_hash_votes()`                                                    | Returns pending launcher hash votes, keyed by the proposal hash of the action voted for.                                                                                                          | `VotesByProposal`        | TBD             | TBD                |
...
| `os_measurement_votes()`                                                   | Returns pending OS measurement votes, keyed by the proposal hash of the action voted for.                                                                                                         | `VotesByProposal`        | TBD             | TBD                |
