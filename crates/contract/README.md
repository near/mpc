...
| `launcher_hash_votes()`                                                    | Returns pending launcher hash votes, keyed by the proposal hash of the action voted for.                                                                                                          | `LauncherHashVotes`      | TBD             | TBD                |
| `code_hash_votes()`                                                        | Returns pending code hash votes, keyed by the image hash voted for.                                                                                                                       | `CodeHashesVotes`        | TBD             | TBD                |
| `allowed_os_measurements()`                                                | Returns all currently allowed OS measurement sets.                                                                                                                                                | `Vec<ExpectedMeasurements>` | TBD  | TBD                |
| `os_measurement_votes()`                                                   | Returns pending OS measurement votes, keyed by the proposal hash of the action voted for.                                                                                                         | `MeasurementVotes`       | TBD             | TBD                |
