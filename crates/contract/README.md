...
| `remove_update_proposal(id: UpdateId)`                                              | Removes a proposed update together with the votes cast for it. Any participant may remove any proposal; the deposit attached at propose time is not refunded.                                                                            | `Result<(), Error>`       | TBD             | TBD                |
