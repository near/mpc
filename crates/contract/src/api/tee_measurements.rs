//! Votes over the measurement sets a node must match to be accepted into
//! the TEE: the MPC node image, the launcher image and its derived compose hashes,
//! and the OS measurements.
...
use crate::tee::proposal::{LauncherVoteAction, NodeImageHash};
