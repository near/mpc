...
pub struct AllowedMpcDockerImage {
    pub(crate) image_hash: DockerImageHash,
...
impl AllowedLauncherImages {
    ...
    pub fn add(
        ...
        current_mpc_image_hashes: &[DockerImageHash],
    ) -> bool {
        if self
            .entries
            .iter()
    ...
    pub fn add_mpc_image_compose_hashes(&mut self, mpc_image_hash: &DockerImageHash) {
...
pub fn get_docker_compose_hash(
    ...
    mpc_docker_image_hash: &DockerImageHash,
