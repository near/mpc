...
pub enum StorageKey {
    ...
    GovernanceVotesByVoterV1,
    GovernanceVotesByProposalV1,
    DomainsVotesByVoterV1,
    DomainsVotesByProposalV1,
    TeeCodeHashVotesByVoterV1,
    TeeCodeHashVotesByProposalV1,
    TeeLauncherVotesByVoterV1,
    TeeLauncherVotesByProposalV1,
    TeeMeasurementVotesByVoterV1,
    TeeMeasurementVotesByProposalV1,
}
