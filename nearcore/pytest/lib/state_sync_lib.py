...
def get_state_sync_config_p2p(tracked_shards_config):
    ...
    config = {
        ...
        "view_client_throttle_period": {"secs": 2, "nanos": 0},
        "consensus.state_sync_external_timeout": {"secs": 0, "nanos": 500000000},
        "consensus.state_sync_p2p_timeout": {"secs": 0, "nanos": 500000000},
        "consensus.state_sync_external_backoff": {"secs": 0, "nanos": 500000000},
        "store.state_snapshot_config.state_snapshot_type": "Enabled",
        "state_sync": {
            "sync": {
                "ExternalStorage": {
                    "location": {"Filesystem": {"root_dir": state_parts_dir}},
...
def get_state_sync_configs_pair(tracked_shards_config="AllShards"):
    ...
    config_dump = {
        "state_sync": {
            "dump": {
                "location": {"Filesystem": {"root_dir": state_parts_dir}},
                "iteration_delay": {"secs": 0, "nanos": 100000000},
            }
        },
        "store.state_snapshot_config.state_snapshot_type": "Enabled",
