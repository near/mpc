...
network_schema = [
    ...
    [PingPong, {"kind": "struct", "fields": [["nonce", "u64"], ["source", PublicKey]]}],
    [
        StateResponseInfo,
        {
            "kind": "enum",
    ...
    [
        RoutingTableSyncV2,
        {"kind": "enum", "field": "enum", "values": [["Version2", RoutingVersion2]]},
    ],
    [
        IbfElem,
        {
