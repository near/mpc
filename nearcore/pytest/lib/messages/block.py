...
class Block:
    def header(self):
        ...
        assert False, (
            "header is called on Block, but the enum variant `%s` is unknown"
            % self.enum
        )
    ...
    def chunks(self):
        if self.enum == "BlockV1":
            ...
            return self.BlockV3.body.chunks
        assert False, (
            "chunks is called on Block, but the enum variant `%s` is unknown"
            % self.enum
        )
...
class BlockHeader:
    def inner_lite(self):
        ...
        assert False, (
            "inner_lite is called on BlockHeader, but the enum variant `%s` is unknown"
            % self.enum
        )
...
class ShardChunkHeader:
    ...
    def signature(self):
        ...
        assert False, (
            "signature is called on ShardChunkHeader, but the enum variant `%s` is unknown"
            % self.enum
        )
...
class ShardChunkHeaderV1:
    ...
    def chunk_hash(inner):
        ...
        inner_serialized = BinarySerializer(
            dict(block_schema + crypto_schema)
        ).serialize(inner)
...
class ShardChunkHeaderV3:
    ...
    def chunk_hash(inner):
        ...
        assert encoded_merkle_root is not None, (
            f"Unknown ShardChunkHeaderV3 enum variant: {inner.enum}"
        )
...
block_schema = [
    ...
    [
        BlockBodyV2,
        {
            ...
            "fields": [
                ...
                ["vrf_value", [32]],
                ["vrf_proof", [64]],
                ["chunk_endorsements", [[{"kind": "option", "type": Signature}]]],
            ],
        },
    ],
    [
    ...
    [
        PartialEncodedChunk,
        {
            "kind": "enum",
            "field": "enum",
            "values": [["V1", PartialEncodedChunkV1], ["V2", PartialEncodedChunkV2]],
        },
    ],
    [
    ...
    [
        CongestionInfo,
        {"kind": "enum", "field": "enum", "values": [["V1", CongestionInfoV1]]},
    ],
    [
        CongestionInfoV1,
        {
    ...
    [
        BandwidthRequests,
        {"kind": "enum", "field": "enum", "values": [["V1", BandwidthRequestsV1]]},
    ],
    [
        BandwidthRequestsV1,
        {"kind": "struct", "fields": [["requests", [BandwidthRequest]]]},
    ],
    [
        BandwidthRequest,
        {
    ...
    [BandwidthRequestBitmap, {"kind": "struct", "fields": [["data", [5]]]}],
    [
        ChunkEndorsement,
        {
            "kind": "enum",
    ...
    [SignatureDifferentiator, {"kind": "struct", "fields": [["0", "string"]]}],
    [
