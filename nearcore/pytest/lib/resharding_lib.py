...
def get_genesis_config_changes(epoch_length, binary_protocol_version, logger=None):
...
def get_client_config_changes(num_nodes, initial_delay=None):
    single = {
        ...
        "resharding_config": {
            ...
            "retry_delay": {"secs": 0, "nanos": 100_000_000},
        },
    }
...
class ReshardingTestBase(unittest.TestCase):
    def setUp(self, epoch_length):
        ...
        self.genesis_num_shards = get_genesis_num_shards(self.binary_protocol_version)
        self.target_num_shards = get_target_num_shards(self.binary_protocol_version)
    ...
    def get_flat_storage_head(self, metrics_tracker: MetricsTracker):
        return metrics_tracker.get_metric_all_values("near_flat_storage_head_height")
