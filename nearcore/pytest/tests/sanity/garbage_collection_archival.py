...
client_config = {
    "consensus": {
        "min_block_production_delay": {"secs": 0, "nanos": 200000000},
        "max_block_production_delay": {"secs": 0, "nanos": 400000000},
        "max_block_wait_delay": {"secs": 0, "nanos": 400000000},
    },
    "gc_step_period": {"secs": 0, "nanos": 100000000},
    "rpc": {
        "polling_config": {
            "polling_interval": {"secs": 0, "nanos": 20000000},
            "polling_timeout": {"secs": 10, "nanos": 0},
        }
    },
...
nodes = start_cluster(
    ...
    {0: client_config, 1: client_config, 2: archival_config},
)
...
for key in keys:
    ...
    tx = sign_create_account_with_full_access_key_and_balance_tx(
        nodes[0].signer_key,
        f"{key}.{nodes[0].signer_key.account_id}",
        nodes[0].signer_key,
        NEAR_BASE,
        nonce,
        block_id.hash_bytes,
