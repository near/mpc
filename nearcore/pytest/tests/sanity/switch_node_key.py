...
config1 = {
    "network": {
        "ttl_account_id_router": {"secs": 1, "nanos": 0},
    }
}
nodes = start_cluster(
    2,
...
assert len(validators["result"]["next_validators"]) == 2, (
    f"unexpected number of validators, next validators: {validators['result']['next_validators']}"
)
