...
node_config["consensus.min_block_production_delay"] = {"secs": 0, "nanos": 100000000}
node_config["consensus.max_block_production_delay"] = {"secs": 0, "nanos": 300000000}
...
epoch_id = nodes[1].json_rpc("block", [node1_height], timeout=15)["result"]["header"][
    "epoch_id"
]
epoch_start_height = nodes[1].get_validators(epoch_id=epoch_id)["result"][
    "epoch_start_height"
]
