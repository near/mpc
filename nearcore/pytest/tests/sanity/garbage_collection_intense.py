...
client_config = {
    "consensus": {
        "min_block_production_delay": {"secs": 0, "nanos": 100000000},
...
nodes = start_cluster(
    ...
    {0: client_config, 1: client_config},
)
...
tx = sign_deploy_contract_tx(nodes[0].signer_key, contract, nonce, last_block_hash)
