...
class ReplayChainFromArchiveTest(unittest.TestCase):
    ...
    def test(self):
        ...
        self.testcase.random_workload_until(
            EPOCH_LENGTH * (GC_NUM_EPOCHS_TO_KEEP + 2) + GC_BLOCKS_LIMIT
        )
        ...
        for node in self.nodes:
            try:
                ...
                assert "code=422" in str(e), (
                    f"Expected status code 422 in exception, got: {e}"
                )
