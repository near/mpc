...
def compute_block_hash(header: typing.Dict[str, typing.Any], msg_version: int) -> str:
...
class HashTestCase(unittest.TestCase):
    ...
    def test_compute_block_hash(self):
        ...
        header = {
            ...
            "next_epoch_id": "AuatKw3hiGmXed3uT2u4Die6ZRGZhEHn34kTyVpGnYLM",
            "prev_hash": "BUcVEkMq3DcZzDGgeh1sb7FFuD86XYcXpEt25Cf34LuP",
            "prev_state_root": "Bn786g4GdJJigSP4qRSaVCfeMotWVX88cV1LTZhD6o3z",
            "block_body_hash": "4K3NiGuqYGqKPnYp6XeGd2kdN4P9veL6rYcWkLKWXZCu",  # some arbitrary string
            ...
            "timestamp": 1642022757141096960,
            "timestamp_nanosec": "1642022757141096960",
            ...
            "rent_paid": "0",
            "validator_reward": "0",
            "total_supply": "3000000000000000000000000000000000",
            "challenges_result": [],
            "last_final_block": "GTudmqKJQjEVCrdi31vcHqXoEpvEScmZ9BhBf3gPJ4pp",
            "last_ds_final_block": "BUcVEkMq3DcZzDGgeh1sb7FFuD86XYcXpEt25Cf34LuP",
            "next_bp_hash": "236RGxQc2xSqukyiBkixtZSqKu679ZxeS6vP8zzAL9vW",
            "block_merkle_root": "Gf3uWgULzc5WDuaAq4feehh7M1TFRFxTWVv2xH6AsnpA",
            "epoch_sync_data_hash": "4JTQn5LGcxdx4xstsAXgXHcP3oHKatzdzHBw6atBDSWV",
            "approvals": [
            ...
            "signature": "ed25519:5mGi9dyuyt7TnSpPFjbEWSJThDdiEV9NNQB11knXvRbxSv8XfBT5tdVVFypeqpZjeB3fD7qgJpWhTj3KvdGbcXdu",
    ...
    def _test_block_hash(
        self, msg_version: int, protocol_version: typing.Optional[int] = None
    ) -> None:
