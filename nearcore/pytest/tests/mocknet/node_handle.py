...
class NodeHandle:
    ...
    def with_schedule_ctx(self, schedule_ctx: Optional[ScheduleContext]) -> Self:
        """
    ...
    def run_cmd(self, cmd, raise_on_fail=False, return_on_fail=False):
        return self.node.run_cmd(self.schedule_ctx, cmd, raise_on_fail, return_on_fail)
    ...
    def neard_runner_jsonrpc_nocheck(self, method, params=[]):
        body = {"method": method, "params": params, "id": "dontcare", "jsonrpc": "2.0"}
    ...
    def neard_runner_make_backup(self, backup_id, description=None):
        return self.neard_runner_jsonrpc(
            "make_backup", params={"backup_id": backup_id, "description": description}
        )
    ...
    def neard_runner_reset(self, backup_id=None):
        return self.neard_runner_jsonrpc("reset", params={"backup_id": backup_id})

    def neard_runner_update_binaries(
        self, neard_binary_url=None, epoch_height=None, binary_idx=None
    ):
        return self.neard_runner_jsonrpc(
            "update_binaries",
            params={
