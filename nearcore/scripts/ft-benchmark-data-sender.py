...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Collect data from local prometheus and send to ft-benchmark db."
    )
    parser.add_argument(
        "--duration", type=int, required=True, help="Duration of experiment in seconds"
    )
    ...
    parser.add_argument("--context", type=str, default="unknown", help="Context")
