...
class test_validator_log_filtering(unittest.TestCase):
    def test_time_filtering(self):
        ...
        output_file_obj = filter_log_file(
            "./tests/data/node0.logs", start_time=start_time, end_time=end_time
        )
        self.assertIsInstance(
            output_file_obj, list, "Parsed file object should be of type io.BytesIO"
        )
