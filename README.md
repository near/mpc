...
MPC nodes can run inside a trusted execution environment (TEE). For more details, see the [TEE design doc](docs/design/securing-mpc-with-tee-design-doc/securing-mpc-with-tee-design-doc.md).
