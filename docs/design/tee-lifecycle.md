...
| `vote_remove_launcher_hash(launcher_hash)` | All | Vote to remove a launcher image hash (unanimity). Unused hashes also auto-expire — see [auto-removal of unused launcher hashes](auto-remove-launcher-hashes-design.md) |
