...
Only the chains with a fingerprint probe read the field at all — starknet, bitcoin, aptos, the EVM
chains and the SVM chains today, the rest as their probes are written. For those chains, leaving it unset is not a silent skip: every
