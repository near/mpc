...
Near One is currently in the process of migrating the MPC nodes into **Trusted Execution Environment (TEEs)** (c.f. [TEE doc](../../design/securing-mpc-with-tee/securing-mpc-with-tee.md) for an introduction to TEEs and their benefits).
