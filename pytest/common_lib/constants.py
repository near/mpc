...
MPC_BINARY_PATH = MPC_REPO_DIR / "target" / "release" / "mpc-node"
BACKUP_SERVICE_BINARY_PATH = MPC_REPO_DIR / "target" / "release" / "backup-cli"
CONFIG_PATH = MPC_REPO_DIR / "pytest" / "config.json"
