...
impl ChainSignatureRequest {
    pub fn new(payload_hash: Scalar, tweak: Scalar, domain_id: DomainId) -> Self {
        let tweak = Tweak::new(tweak.to_bytes().into());
...
impl ChainRespondArgs {
    ...
    pub fn new(
        ...
        Ok(ChainRespondArgs {
            request: ChainSignatureRequest::new(request.msg_hash, request.tweak, domain_id),
